...
export branch_name="RastroBus-$(date +%d%m%Y)"
...
git commit -am "RastroBus - Semi-finalização do Rotasprevistas.item - feito catalogo e puxado pelo id (formatar style ainda) - $(date)"
