...
export branch_name="filtro-pesquisa-endereco-80%-$(date +%m%d)"
...
git commit -am "RastroBus - Filtros pronto, agora falta a parte da busca direcionando para o mapa. - $(date)"
